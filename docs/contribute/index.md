...
id: contribute
title: Contributing
description: Contributing to Stirling-PDF
generated: true
---
...
If you would like to add or modify a translation, please see [How to add new languages to Stirling-PDF](translation.md). Also, please create a Pull Request so others can use it!
...
To build from source, please follow this [Guide](https://github.com/Ludy87/Stirling-PDF/blob/main/LocalRunGuide.md).
...
By contributing to this project, you agree that your contributions will be licensed under the [LICENSE](https://github.com/Ludy87/Stirling-PDF/blob/main/LICENSE). You also acknowledge and agree that your contributions will be included in Stirling-PDF and that they can be relicensed in the future under the MPL 2.0 (Mozilla Public License Version 2.0) license.
