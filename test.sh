...
main() {
    ...
    docker build --build-arg VERSION_TAG=alpha -t ludy87/s-pdf:latest -f ./Dockerfile .
    docker build --build-arg VERSION_TAG=alpha -t ludy87/s-pdf:latest-ultra-lite -f ./Dockerfile-ultra-lite .
